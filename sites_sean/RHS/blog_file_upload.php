...
<html>
<head>
<title><?php print $blogName; ?> - New File Sharing Post</title>
       ...
       <input name="blItemType" type="hidden" id="blItemType" value="TEXT">
		...
		<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td width="85%" align="right" valign="middle"> &nbsp; <input name="blHeadline" type="text" id="blHeadline" value="<?php print $blHeadline; ?>" size="80"> 
              &nbsp; </td>
          </tr>
          <tr> 
            <td height="40" align="right" valign="middle" bgcolor="#FFFFFF" class="cts12Bold">SubHead:&nbsp;&nbsp;</td>
          ...
          <tr> 
            <td height="40" align="right" valign="middle" bgcolor="#FFFFFF" class="cts12Bold">File 
              to Share:&nbsp;&nbsp;</td>
            <td align="right" valign="middle">&nbsp; <input name="blUploadFile" type="file" id="gaFileToSend500x3" size="70" /> 
              &nbsp;</td>
          </tr>
          <tr> 
            ...
            <td height="330" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td align="center"> <textarea name="blCopy" cols="79" rows="20" id="elm1"><?php print $blCopy; ?></textarea> 
                    &nbsp; </td>
                </tr>
              </table>
              &nbsp; </td>
