		  ...
		  <tr>
			...
			<tr> 
			  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr> 
					<td width="50%" valign="top"> <table width="2" border="1" align="center" cellpadding="0" cellspacing="0">
						<tr> 
						  <td><table width="10%" border="0" align="center" cellpadding="0" cellspacing="0">
							  ...
							  <tr> 
								<td height="20" bgcolor="#EEEEEE" class="admin12Regular">&nbsp;&nbsp;500x 
								  File</td>
							  </tr>
							</table></td>
						</tr>
					...
					<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr> 
						  <td><table width="2%" border="1" align="center" cellpadding="0" cellspacing="0">
							  <tr> 
								<td><table width="10%" border="0" align="center" cellpadding="0" cellspacing="0">
									<tr> 
									  <td>' . $imageTag200x . '</td>
									...
									<tr> 
									  <td height="20" bgcolor="#EEEEEE" class="admin12Regular">&nbsp;&nbsp;200x 
										File</td>
									</tr>
								  </table></td>
							  </tr>
						...
						<tr> 
						  <td align="right"> <table width="90%" border="1" cellpadding="5" cellspacing="0" class="admin12Regular">
							  <tr> 
								<td width="20%" height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Title:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $title . '</td>
							  </tr>
							  <tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Caption:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $caption . '</td>
							  </tr>';
								...
								print '
								<tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Location:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $location . '</td>
								</tr>
								<tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Media:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $media . '</td>
								</tr>';

								print '
								<tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Artist:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $artist . '</td>
								</tr>
								<tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">File 
								  Name:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $fileName . '</td>
								</tr>';
								}
							  ...
							  print '
							  <tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Size 
								  1:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $size1Message . '</td>
							  </tr>
							  <tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Size 
								  2:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $size2Message . '</td>
							  </tr>
							  <tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Size 
								  3:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $size3Message . '</td>
							  </tr>
							  <tr> 
								<td height="25" align="right" valign="middle" bgcolor="#EEEEEE" class="admin10Regular">Size 
								  4:&nbsp;&nbsp;</td>
								<td class="admin10Regular">' . $size4Message . '</td>
							  </tr>
							</table></td>
						</tr>
					  </table></td>
