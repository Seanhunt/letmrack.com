...
-- 
-- Host: fatcow
-- Generation Time: Nov 07, 2007 at 02:49 PM
...
INSERT INTO `APPDEV_BLOG_CalendarBlog` VALUES ('Is the Christmas yet daddy ?', 'urrrrrk!', 'hehheheh!<br>', 'clark', '2007-11-06 17:54:41', '2007-12-25', '7:00 AM', 'TEXT', 'SHOW', 40, 'RANDOM', 0);
...
INSERT INTO `APPDEV_ChronProcess` VALUES ('CALENDAR', '2007-11-06 17:48:54', '');
...
-- 
-- Table structure for table `APPDEV_GALLERY_libby`
-- 

DROP TABLE IF EXISTS `APPDEV_GALLERY_libby`;
CREATE TABLE IF NOT EXISTS `APPDEV_GALLERY_libby` (
  `FileName` text NOT NULL,
  `RecordNumber` int(4) unsigned NOT NULL auto_increment,
  PRIMARY KEY  (`RecordNumber`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='This is a gallery table template' AUTO_INCREMENT=1 ;

-- 
-- Dumping data for table `APPDEV_GALLERY_libby`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='This holds all of the gallery descriptions' AUTO_INCREMENT=16 ;
...
INSERT INTO `APPDEV_GalleryProfiles` VALUES ('No300xPhoto.jpg', 'New Gallery for libby', '', '', '', '', '', '', '', '', '', '', 'libby', 'HIDE', 'FORSALE', 'thumbs.php', 'image.php', 0, 15);
...
INSERT INTO `APPDEV_MailingListNames` VALUES ('Desktops', 'An occasional link to a nature photo desktop.', 'Y');
INSERT INTO `APPDEV_MailingListNames` VALUES ('Newsletter', 'An occasional newsletter on photographic technique.', 'N');
...
INSERT INTO `APPDEV_PasswordTargets` VALUES ('Delivery', 'cajun', 'dance', 'halloween07', '');
...
INSERT INTO `APPDEV_SimpleCounters` VALUES ('index.php', 13138, 9337);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('galleries.php', 3622, 2467);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('about.php', 2018, 1073);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('subscription_signup.php', 801, 477);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('prices.php', 1236, 838);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('potw.php', 1461, 992);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('photo_blog.php', 2296, 1603);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('desktops.php', 4896, 3688);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('free_desktop.php', 6731, 4063);
...
INSERT INTO `APPDEV_SimpleCounters` VALUES ('GalleryImage', 270, 101);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('Home', 91, 48);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('Events', 3, 3);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('GalleryLobby', 90, 74);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('Contact', 43, 26);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('MailSignUp', 39, 38);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('About', 16, 15);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('MailSubManager', 11, 10);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('Calendar', 57, 52);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('Blog', 33, 21);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('Sale', 15, 0);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('DetailImage', 38, 0);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('FreeDesktops', 1, 0);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('760-MeyersRanchMeadow.jpg', 1, 0);
INSERT INTO `APPDEV_SimpleCounters` VALUES ('', 9, 0);
