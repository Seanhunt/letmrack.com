...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="70" align="center" valign="top" class="cts24Bold"><h1><?php print $gSiteName; ?> 
      FTP Delivery</h1></td>
  </tr>
  <tr>
    <td><table width="50%" border="`" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="46%"><h3 class="cts15Regular">Here is the private link to 
              your file:</h3>
          <p class="cts15Regular"><a class="boldLink14" href="<?php print $location; ?>"><?php print $fileName; ?></a></p>
            <p class="cts15Regular">Right - Click on the PC </p>
            <p class="cts15Regular">or... </p>
            <p class="cts15Regular">Option - Click on Apple </p>
            <p class="cts15Regular">Then  select the save option from the menu that 
              appears. </p>
